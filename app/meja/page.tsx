                ...
                >
                  ...
                  <CardFooter>
                    <Button className="w-full" asChild>
                      <Link href={`/reservasi?table=${table.id}`}>Reservasi Meja Ini</Link>
                    </Button>
                  </CardFooter>
                </Card>
              ))}
              ...
              <div className="mt-4 grid gap-6 md:grid-cols-3">
                <div>
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Meja indoor kami menawarkan kenyamanan dengan AC dan suasana yang tenang. Cocok untuk pertemuan
                    bisnis atau makan malam romantis.
                  </p>
                </div>
                <div>
                  <h3 className="flex items-center gap-2 font-medium">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Meja outdoor kami menawarkan pengalaman makan di bawah langit dengan pemandangan taman. Sempurna
                    untuk makan siang santai.
                  </p>
                </div>
                <div>
                  <h3 className="flex items-center gap-2 font-medium">
