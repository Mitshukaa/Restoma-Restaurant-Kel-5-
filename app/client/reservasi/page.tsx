    ...
    <div className="mx-auto max-w-4xl p-4 md:p-8">
      ...
      <div className="mt-8 rounded-lg bg-muted p-6">
        ...
        <div className="mt-4 space-y-4">
          <p>
            <strong>Kebijakan Reservasi:</strong> Reservasi hanya valid selama 15 menit dari waktu yang ditentukan.
            Setelah itu, meja akan diberikan kepada pelanggan lain.
          </p>
          <p>
            <strong>Pembatalan:</strong> Pembatalan dapat dilakukan minimal 2 jam sebelum waktu reservasi tanpa biaya.
          </p>
          <p>
